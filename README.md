...
- [Google Gemini](https://aistudio.google.com/app/apikey) for LLM inference and Text-to-Speech

> 💡 **Tip**: Sign up for these services now. You'll need them for both local and cloud deployment.
